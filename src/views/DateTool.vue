...
<template>
  <div class="w-full h-[calc(100vh-68px)] px-2 py-0 broder border-gray-500 flex flex-col justify-center">
    ...
    <div class="flex-1 w-full border dark:border-[#4C4D4F] rounded-md">
      <router-view />
    </div>
  </div>
</template>
